"use strict";
const stylesToNumber = ({ style }) => {
    return Number(style.replace(/[^\d.]/g, ''));
};
let startTime, endTime;
const start = ({ length, min, max }) => {
    const body = document.querySelector('body');
    const sections = body === null || body === void 0 ? void 0 : body.querySelectorAll('section');
    const canvas = body === null || body === void 0 ? void 0 : body.querySelector('#app');
    const mergeSortBtn = body === null || body === void 0 ? void 0 : body.querySelector('.mergeSortingBtn');
    const selectionSortBtn = body === null || body === void 0 ? void 0 : body.querySelector('.selectionSortingBtn');
    const generateNumbersBtn = body === null || body === void 0 ? void 0 : body.querySelector('.generateNumbers');
    const ctx = canvas === null || canvas === void 0 ? void 0 : canvas.getContext('2d');
    const numberOperationsElement = body === null || body === void 0 ? void 0 : body.querySelector('.numberOperations');
    const runtimeElement = body === null || body === void 0 ? void 0 : body.querySelector('.runtime');
    if (!body ||
        !canvas ||
        !mergeSortBtn ||
        !canvas ||
    ...
    if (max - min < length)
        throw new Error('You need to increase min/max for that amount of numbers');
    ...
    const setNumberData = () => {
        let maxNum = Math.max.apply(Math, numbers.map((el) => el.number));
    ...
    const generateNumbers = ({ length, min, max }) => {
        reset();
        let number = 0;
        const setRandom = () => {
        ...
        for (let i = 0; i < length; i++) {
            ...
            numbers[i] = Object.assign(Object.assign({}, numbers[i]), { number });
        }
        setNumberData();
        drawNumberData();
    };
    ...
    const merge = ({ left, right }) => {
        ...
        while (left && right && left.length && right.length) {
            ...
            if (left[0].number < right[0].number) {
                sortedNumbers.push(left.shift());
            }
            else {
                sortedNumbers.push(right.shift());
            }
        }
    ...
    selectionSortBtn === null || selectionSortBtn === void 0 ? void 0 : selectionSortBtn.addEventListener('click', (e) => {
        reset();
